...
struct ContentView: View {
    ...
    var output: Double {
        ...
        let k = inputUnit.converter.baseUnitValue(fromValue: temperature)
        // convert from k to output
        return outputUnit.converter.value(fromBaseUnitValue: k)
    }
    ...
    var body: some View {
        NavigationView {
            Form {
                Section {
                    TextField("Input", value: $temperature, format: .number)
                ...
                Section {
                    ...
                    Text("Converted to \(outputUnit.symbol)")
                }
            }
